...
- Read about a *Christian Perspective on Dreams*
- Read and Reflect: *Birth Order and Your Personality*
- Explore the three resources on self-esteem and humanistic psychology
- Explore the *Queendom* personality resource and take a personality test (ungraded)
...
***Assessment*** In this course you demonstrate your understanding of the course learning outcomes in different ways, including papers, projects, discussions and quizzes. Please see the Assessment section in Moodle for assignment details and due dates.
...
### Personality Theories {.unnumbered}
...
### Self-Esteem {.unnumbered}

In 1890, William James gave a simple formula for self-esteem:

> $\text{Self-Esteem}=\frac{\text{Success}}{\text{Pretensions}}$
...
### Self-Esteem: A Contrary View {.unnumbered}
...
### Measuring Personality {.unnumbered}
...
*Queendom.com* is a great resource for different kinds of tests. You will be looking specifically at Personality tests on this site. When you go to [www.queendom.com,](www.queendom.com,){target="_blank"} click on the **"TESTS, QUIZZES & POLLS"** tab and select **TESTS.** From the **PERSONALITY TESTS** list select ONE of the following personality tests:
...
### You + Your Environment {.unnumbered}
...
- [**Learned Optimism**](https://nesslabs.com/learned-optimism){target="_blank"}
...
### Activity: Chapter 12 Key Terms Quiz
...
<iframe src="https://create.twu.ca/h5p/wp-admin/admin-ajax.php?action=h5p_embed&id=81" width="936" height="874" frameborder="0" allowfullscreen="allowfullscreen" title="Psych 106 - Unit 5 Quiz"></iframe><script src="https://create.twu.ca/h5p/wp-content/plugins/h5p/h5p-php-library/js/h5p-resizer.js" charset="UTF-8"></script>
