...
2. Humanistic View
3. Christianity & Humanism
4. Trait View
5. Social-Cognitive View
...
*Queendom.com* is a great resource for different kinds of tests. You will be looking specifically at Personality tests on this site. When you go to [www.queendom.com,](https://www.queendom.com/){target="_blank"} click on the **"TESTS, QUIZZES & POLLS"** tab and select **TESTS.** From the **PERSONALITY TESTS** list select ONE of the following personality tests:
